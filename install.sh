...
install -v -m 755 $BASE_PATH/orac-bonnet-bridge/images/oracsplash.ppm /usr/local/bin/images/
install -v -m 755 $BASE_PATH/orac-bonnet-bridge/images/oractitle.ppm /usr/local/bin/images/
